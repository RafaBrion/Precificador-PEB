  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-selected:bg-background data-selected:text-foreground data-selected:border-pietro-orange data-selected:border-2 dark:data-selected:border-input dark:data-selected:bg-input/30 dark:data-selected:text-foreground",
